...
class NodeStatus {
  ...
  static const running = NodeStatus._(r'running');
  static const stopped = NodeStatus._(r'stopped');
  static const maintenance = NodeStatus._(r'maintenance');
...
class NodeStatusTypeTransformer {
  ...
  NodeStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'running': return NodeStatus.running;
        case r'stopped': return NodeStatus.stopped;
        case r'maintenance': return NodeStatus.maintenance;
        default:
          if (!allowNull) {
